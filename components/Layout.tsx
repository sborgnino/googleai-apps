  ...
  return (
    <div className="flex flex-col h-screen bg-slate-900 text-slate-50 overflow-hidden">
      ...
      <nav className="flex-none border-t border-slate-800 bg-slate-900 pb-safe fixed bottom-0 w-full md:static md:w-auto md:border-t-0 md:bg-transparent md:pb-0">
         {/* Mobile Bottom Nav - hidden on desktop if we wanted a sidebar, but keeping it simple for now */}
        ...
        {/* Desktop Nav - A simple variation could be added here, but using the bottom nav for simplicity on all sizes as requested by mobile-first approach */}
      </nav>
    </div>
  );
};
